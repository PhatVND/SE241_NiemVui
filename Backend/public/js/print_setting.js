...
// //   e.preventDefault();
//     let status = document.getElementById("fileStatus").innerText;
//     const myArray = status.split(":");
//     (myArray[0] == `Đã tải tệp`) ? (isFileUploaded = true) : (isFileUploaded = false)
//   if (isFileUploaded) {
//     const formSetting =document.querySelector("printForm");
//     formSetting.submit();
